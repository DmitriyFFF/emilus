...
const clientData = fetch('https://jsonplaceholder.typicode.com/users').then(res => res.json())
				...
				render: (_, elm) => (
					<div className="text-right">
						...
						<Tooltip title="Delete">
							<Button danger icon={<DeleteOutlined />} onClick={()=> {this.deleteClient(elm.id)}} size="small"/>
						</Tooltip>
					</div>
				)
			}
